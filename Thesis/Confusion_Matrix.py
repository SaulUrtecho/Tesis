...
# Cargamos el modelo
modelo = load_model('C:/Users/saulu/Documents/Proyecto_Tesis/Thesis/DATOS_RED/Modelo.h5')
...
plt.savefig('C:/Users/saulu/Documents/Proyecto_Tesis/Thesis/METRICAS/GraficaROC.png')
plt.show()
...
results.to_excel('C:/Users/saulu/Documents/Proyecto_Tesis/Thesis/METRICAS/Predicciones.xlsx', sheet_name='Resultados de las Predicciones')
print(results)
...
archivoPuntajes = open('C:/Users/saulu/Documents/Proyecto_Tesis/Thesis/METRICAS/Scores.txt', 'w')
...
plt.savefig('C:/Users/saulu/Documents/Proyecto_Tesis/Thesis/METRICAS/MatrizConfusion.png')
plt.show()
plt.close()
